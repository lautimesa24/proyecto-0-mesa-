...
* **Lectura robusta:** este programa Procesa archivos de texto plano separados por punto y coma(;), ignorando líneas mal formadas o sin ciudad válida sin interrumpir la ejecución.
* **Limpieza de datos:** Limpia los espacios en blanco sobrantes en los nombres de las estaciones y maneja adecuadamente los datos faltantes (como la sensación térmica con el valor "No se calcula").
